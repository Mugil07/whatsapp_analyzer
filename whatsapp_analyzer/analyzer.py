...
if upload is not None:
   ...
   # df = dataframe.copy()
    ...
    if st.sidebar.button('Show'):
        ...
        user_df = supporter.dataframe(selected_user,df_1)
        st.title('Member Chat')
        st.dataframe(user_df)
        st.title("Member Statistic")
        num_messages, words, num_media, links = supporter.fetch_stats(selected_user,df_1)
        ...
        if user_df.empty:
            ...
            timeline_df= supporter.monthly_timeline(selected_user, df_1)
            fig, ax= plt.subplots()
            ...
            daily_timeline_df= supporter.daily_timeline(selected_user, df_1)
            fig, ax= plt.subplots()
            ...
            with col1:
                ...
                busy_day=supporter.weekly_activity(selected_user, df_1)
            ...
            with col2:
                ...
                busy_month=supporter.month_activity(selected_user, df_1)
            ...
            common_df= supporter.most_common_words(selected_user,df_1)
            ...
            emoji_df = supporter.show_emoji(selected_user,df_1)
